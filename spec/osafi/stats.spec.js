...
describe('stats', () => {
    ...
    describe('ball in play', () => {
        pluginTest(pluginPath, 'ball not in play when it has not moved or until the reset after a goal is made', ({ room, progressGame, setBallPosition, startGame, goal, resetPositions }) => {
            startGame();
